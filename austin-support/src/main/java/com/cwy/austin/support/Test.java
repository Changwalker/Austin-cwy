package com.cwy.austin.support;
...
public class Test {
    public static void main(String[] args) {
        try{
            LombokTest lombokTest1 = LombokTest.builder().id("1").name("投币").build();
            LombokTest lombokTest2 = LombokTest.builder().id("2").name("点赞").build();
